...
\noindent\textbf{Heat waves in India}: Severe heat waves, mainly from April to June, are a major public health risk in India, particularly for outdoor workers, the elderly, children, and people without access to cooling. The National Disaster Management Authority (NDMA) issues district-level heat wave warnings and action plans. During a heat wave, avoid outdoor activity between 12 noon and 3 p.m., drink water regularly, and check on vulnerable neighbours. See Chapter~\ref{ch:disaster} for heat wave preparedness details.
...
\begin{enumerate}[leftmargin=*]
  ...
  \item Even if the victim seems fine after resuscitation, seek medical evaluation as "secondary drowning" (delayed pulmonary edema) can occur hours later
