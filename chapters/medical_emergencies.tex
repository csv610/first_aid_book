...
A stroke occurs when blood supply to part of the brain is interrupted or reduced, preventing brain tissue from getting oxygen and nutrients. Brain cells begin to die within minutes \cite{nih_stroke}.
...
Anaphylaxis is a life-threatening systemic allergic reaction that can occur rapidly after exposure to an allergen. Common triggers: foods (peanuts, tree nuts, shellfish, eggs, milk), insect stings, medications, latex \cite{wao_anaphylaxis_2020}.
